...
output:
  pagedown::html_resume:
    ...
    css: 
      ...
      - /Library/Frameworks/R.framework/Versions/4.3-arm64/Resources/library/autoCV/css/override.css 
      # DEFAULT FILE
      - resume 
...
library(autoCV)
### Set your working directory (`wd`) to 
wd <- autoCV::ex_data() ## <-- Change this path to where your data is
