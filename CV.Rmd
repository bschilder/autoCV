...
<!-- Custom Info -->
```{r}
wd <- "/Library/Frameworks/R.framework/Versions/4.3-arm64/Resources/library/autoCV" ## <-- Change this path to where your "cv_data" and "img" subfolders are stored
...
```{r}
build_title(name = "Leonardo da Vinci",
            tagline = "Simplicity is the ultimate sophistication.",
            extra = "### Studio of Andrea del Verrocchio
### Painter, draughtsman, engineer, scientist
### MD, PhD", 
            logo = "<a href='https://github.com/bschilder/autoCV' target='_blank' class='image'><img src='/Users/bms20/Desktop/autoCV/inst/img/davinci.png' alt='header_img' id='header_img' width='60px' style='border-radius:5%;'></a>")
```
